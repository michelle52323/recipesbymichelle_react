...
function AnswerChoiceListDesktop({ questionId, answerChoices, setAnswerChoices, onRequestDelete }: Props) {

    const [expandedId, setExpandedId] = useState<string | null>(null);

    // console.log(
    //         "Desktop onRequestDelete:",
    //         onRequestDelete,
    //         "typeof:",
    //         typeof onRequestDelete
    //     );
...
export default AnswerChoiceListDesktop;