...
- ![Recipe Steps - Dark Teal](./screenshots/02-Steps.png)
*Add and organize step‑by‑step instructions using a distraction‑free editing layout.*

- ![View Recipe - Dark Teal](./screenshots/03-View-Recipe.png)
*View recipes in a clear, mobile‑friendly layout optimized for cooking.*

- ![View Recipe using Handwritten Font - Dark Teal](./screenshots/04-Handwritten-Font.png)
